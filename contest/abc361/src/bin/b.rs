...
#[allow(non_snake_case)]
fn main() {
    input!(a: i32, b: i32, c: i32, d: i32, e: i32, f: i32, g: i32, h: i32, i: i32, j: i32, k: i32, l: i32);

    if has_intersection(a, b, c, d, e, f, g, h, i, j, k, l) {
        println!("Yes");
    } else {
        println!("No");
    }
...
fn has_intersection(
    ...
    let x_overlap = overlap(a, d, g, j);
    let y_overlap = overlap(b, e, h, k);
    let z_overlap = overlap(c, f, i, l);

    x_overlap > 0 && y_overlap > 0 && z_overlap > 0
}

fn overlap(start1: i32, end1: i32, start2: i32, end2: i32) -> i32 {
